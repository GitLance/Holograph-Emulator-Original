...
#Region "Misc status handlers"
    Friend Shadows ReadOnly Property ToString()
        Get
            Dim detailsStack As String = "i:" & roomUID & sysChar(13) & _
            "n:" & Name & sysChar(13) & _
            "f:" & Figure & sysChar(13) & _
            "s:" & Sex & sysChar(13) & _
            "l:" & PosX & " " & PosY & " " & PosH & sysChar(13)
            If Not (Mission = vbNullString) Then detailsStack += "c:" & Mission & sysChar(13)
            If Not (nowBadge = vbNullString) Then detailsStack += ("b:" & nowBadge & sysChar(13))
