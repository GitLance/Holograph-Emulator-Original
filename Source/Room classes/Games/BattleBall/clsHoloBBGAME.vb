...
Public Class clsHoloBBGAME
    ...
    Public Sub Dump()
        ...
        For TT = 0 To teamCount - 1
            For Each subViewer In teamMembers(TT).Values
                ...
                subViewer.Game_ID = -1
                subViewer.userClass.transData("CmH")
            Next
        Next
    ...
    Public Sub startGame()
        Dim gameMap As String = "@S" & "Bf" & "http://www.holographemulator.com/" & "AE" & HoloDB.runRead("SELECT name_ae FROM publicrooms WHERE id = '9" & mapID & "' LIMIT 1")
        gameMap += "CP0" & "@_" & HoloDB.runRead("SELECT map_height FROM publicrooms WHERE id = '9" & mapID & "' LIMIT 1")
    ...
    Public Function getGameSub()
        ...
        navPack.Append(HoloENCODING.encodeVL64(startStatus) & HoloENCODING.encodeVL64(canStart) & Name & Convert.ToChar(2) & HoloENCODING.encodeVL64(OwnerRoomIdentifier) & Owner & Convert.ToChar(2) & HoloENCODING.encodeVL64(mapID) & HoloENCODING.encodeVL64(Spectators.Count) & HoloENCODING.encodeVL64(teamCount))
        ...
        For T = 0 To teamCount - 1
            ...
            For Each teamMember As clsHoloUSERDETAILS In teamMembers(T).Values
                navPack.Append(HoloENCODING.encodeVL64(teamMember.roomUID) & teamMember.Name & Convert.ToChar(2))
            Next
        Next
        ...
        navPack.Append("9" & Convert.ToChar(2))
